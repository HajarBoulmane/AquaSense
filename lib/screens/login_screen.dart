...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(message), backgroundColor: const Color(0xFFFF3B5C)),
      );
    } finally {
      ...
      child: Column(
        ...
        children: [
          ...
          _AquaTextField(
            ...
            suffixIcon: IconButton(
              icon: Icon(
                _registerPasswordVisible ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                color: Colors.white38, size: 20,
              ),
          ...
          _AquaTextField(
            ...
            suffixIcon: IconButton(
              icon: Icon(
                _registerConfirmPasswordVisible ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                color: Colors.white38, size: 20,
              ),
              onPressed: () => setState(() => _registerConfirmPasswordVisible = !_registerConfirmPasswordVisible),
            ),
          ),
          const SizedBox(height: 10),
          Row(children: [
  ...
  Widget _SubTitle(String text) {
    return Text(text, style: TextStyle(color: Colors.white.withOpacity(0.4), fontSize: 13));
  }
}
    ...
    return SizedBox(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(14),
          boxShadow: [
            BoxShadow(color: const Color(0xFF00D4FF).withOpacity(0.3), blurRadius: 16, offset: const Offset(0, 6)),
          ],
        ),
...
class _WavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(size.width * 0.85, size.height * 0.1), size.width * 0.45, glowPaint);
  }
